...
latest_iteration_2026_09_01:
  ...
  own_change: Experiment 090 replay now emits bounded interactionMetrics, exposes only sampleCount and signalCoverage in the PUPILA participant view, and emits deterministic pupilaViewDiffs so consumers update only changed fields.
  evidence: 090 contract passes 19 tests, cross-branch replay reports 4 accepted and 1 duplicate, payloadForwarded=false, the final PUPILA view remains safe, and the duplicate produces an empty diff.
